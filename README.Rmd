...
The `stenographer` package is a flexible and powerful logging system for R applications. It provides a `Stenographer` class for creating customisable loggers, as well as helper functions for debugging and error reporting.
